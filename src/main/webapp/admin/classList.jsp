		...
		<table class="table table-bordered mt-4 text-center">
			...
			%>
				<tr>
					...
					<td><a href="${ctx}/admin/classDelete.jsp?classNo=<%=dto.getClassNo() %>" class="btn btn-sm btn-danger">삭제</a></td>
				</tr>
			<%} %>
			</tbody>
		</table>
		<a href="classInsert.jsp" class="btn btn-primary w-25 mt-3">강의등록</a>
	</div>
</main>
